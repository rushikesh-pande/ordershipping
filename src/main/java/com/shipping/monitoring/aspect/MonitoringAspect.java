package com.shipping.monitoring.aspect;
...
public class MonitoringAspect {
    ...
    public Object monitorControllerMethod(ProceedingJoinPoint pjp) throws Throwable {
        ...
        String metricName = "ordershipping.controller.duration";
        ...
        try {
            ...
            Counter.builder("ordershipping.controller.errors")
    ...
    public Object monitorServiceMethod(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            meterRegistry.timer("ordershipping.service.duration",
