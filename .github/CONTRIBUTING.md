...
```bash
# Clone the repo
git clone https://github.com/rushikesh-pande/ordershipping.git
cd ordershipping
...
Open a [Discussion](https://github.com/rushikesh-pande/ordershipping/discussions) or
